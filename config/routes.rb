Edge::Application.routes.draw do 
  ...
  # *** Cary *** - The following two routes are the headache. 
  ...
  # match "/projects/:proj_id/:controller/:action(/:id(.:format))", :constraints => {:controller => /public/}
  # match "/:controller/:action(/:id(.:format))", :constraints => {:controller => /public/}
