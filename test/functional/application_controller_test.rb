...
class  ApplicationController; def rescue_action(e) raise e end; end # Raise errors beyond the default web-based presentation

  class ApplicationControllerTest < ActionController::TestCase

    def setup
      # doesn't really matter what controller we have for routes testing...
