...
class OntologyClassesControllerTest < ActionController::TestCase
  def setup
    $person_id = 1
    $proj_id = 1
  ...
  test "should create ontology_class" do
    ...
    assert_redirected_to :controller => :ontology_classes, :action => :show, :id => assigns(:ontology_class) # @ontology_class # "http://test.host/projects/1/ontology_class/show/" # ontology_class_path(assigns(:ontology_class))
  end
  ...
  test "should update ontology_class" do
    ...
    assert_redirected_to ontology_class_path
  end

  test "should destroy ontology_class" do
    assert_difference('OntologyClass.count', -1) do
      delete :destroy, @opts.merge(:id => @ontology_class.id)
    end
    assert_redirected_to :controller => "ontology_classes", :action => "list"
  end
