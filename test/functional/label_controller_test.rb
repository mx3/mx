...
class LabelControllerTest < ActionController::TestCase
  ...
  test "should create label" do
    ...
    assert_redirected_to :controller => :label, :action => :show, :id => assigns(:label)
  ...
  test "should update label" do
    ...
    assert_redirected_to :action => :show, :controller => :label, :id => @label.id
  ...
  test "should destroy label" do
    ...
    assert_redirected_to :controller => "label", :action => "list"  
  end
end
