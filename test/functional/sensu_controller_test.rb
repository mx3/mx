...
class SensuControllerTest < ActionController::TestCase
  def setup
  ...
  test "should create sensu" do
    ...
    assert_redirected_to :controller => :sensu, :action => :show, :id => assigns(:sensu) # @sensu # "http://test.host/projects/1/sensu/show/" # sensu_path(assigns(:sensu))
  end
  ...
  test "should update sensu" do
    ...
    assert_redirected_to :action => :show, :controller => :sensu, :id => @sensu.id # assigns(:sensu)
  
    # assert_redirected_to # sensus_path(assigns(:sensu))   # not yet RESTful
  end

  test "should destroy sensu" do
    assert_difference('Sensu.count', 0) do
      delete :destroy, @opts.merge(:id => @sensu.id)
    end
      assert_redirected_to :controller => "sensu", :action => "list"  
  end
