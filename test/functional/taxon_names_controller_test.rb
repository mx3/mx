...
require 'taxon_names_controller'

# Re-raise errors caught by the controller.
class TaxonNamesController; def rescue_action(e) raise e end; end
...
class TaxonNamesControllerTest < ActionController::TestCase
  ...
  def setup
    ...
    @controller = TaxonNamesController.new
    login
    @opts =  {:controller => 'taxon_names', :proj_id => "1"}
  end
