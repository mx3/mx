class Api::MxesController < ApplicationController

  # !! TODO: REVISIT, but could be OK.
  skip_before_filter :configure_site
 
  after_filter :set_access_control_headers

  # TODO: Need to lock this down ultimately
  ...
  def index
    redirect_to "http://#{HELP_WIKI}/index.php/App/API/Mxes"
  end
  ...
  def jmatrixbrowse
     @mx = Mx.find(params[:id])
      ...
      render :json => @mx.jmatrix_browse_window(params)
  end
