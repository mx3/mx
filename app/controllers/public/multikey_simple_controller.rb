class Public::MultikeySimpleController < Public::BaseController
 
  before_filter :find_key, :except => [:reset, :_popup_figs_for_state, :_close_popup_figs, :list, :add_state, :remove_state, :return_otu, :return_chr, :choose_otu, :_update_otu_for_compare, :_popup_figs_for_state, :_popup_figs_for_chr, :_close_popup_figs]
  before_filter :set_key, :only => [:add_state, :remove_state, :return_otu, :return_chr, :choose_otu, :_update_otu_for_compare, :_popup_figs_for_state, :_popup_figs_for_chr]
  ...
  before_filter :check_for_bot_formatted_links_and_return_404s, :only => [:add_state, :remove_state, :return_otu, :return_chr, :choose_otu]
 ...
 #  @mk = find_key
  ...
  def find_key
    begin
      ...
      @mk.display_windows['chr_elim']['size'] = @mk.all_chrs.size
      @mk.display_windows['otu_elim']['size'] = @mk.all_chrs.size
      @mk.display_windows['chr_remn']['size'] = @mk.all_chrs.size # chrs_remaining.size
      @mk.display_windows['otu_remn']['size'] = @mk.all_otus.size # 15 # @mk.chrs_remaining.size
    rescue
