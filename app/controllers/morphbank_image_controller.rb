...
class MorphbankImageController < ApplicationController
  ...
  def create
    ...
    begin
     ...
     redirect_to :action => :show, :id => @morphbank_image.id, :controller => :image and return
  ...
  def edit
    ...
    if  @morphbank_image == nil
      ...
      redirect_to :action => 'list', :controller => 'image' and return      
    end
  end
  ...
  def update
    ...
    if @morphbank_image.update_attributes(params[:morphbank_image])
      ...
      redirect_to :action => 'show', :id => @morphbank_image, :controller => 'image'
    else
      render :action => 'edit'
    end
  end
  ...
  def show
    redirect_to :action => :show, :id => params[:id], :controller => :image
  end
  ...
  def _add_thumb
    ...
    render :action => :search, :controller => :morphbank_image
  end
