...
class ApplicationController < ActionController::Base
 # include ExceptionNotification::Notifiable
  ...
  helper 'app/layout', 'app/layout' , 'app/display', 'app/navigation', :coding, :javascript, :otus, :seq, :specimen, :taxon_name, :figures, :image, :confidence, :trait, :ref, :sensu, :content, :geog, :ontology_relationship, :ontology_class, :tag, :image_description, :public_content, :extracts_gene, :label, :ontology, :phenotype, :ce, :namespace
