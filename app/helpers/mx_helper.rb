module MxHelper
  ...
  def vertical_char_text(chrs)
    s = "data:image/svg+xml,
          ...
          <g transform='translate(7,0) rotate(90)' font-size='12' font-family='Tahoma' fill='%23000'>" 
  ...
  def angled_char_text(chrs)
      s = "data:image/svg+xml,
          ...
          <g transform='translate(10,45)' font-size='12' font-family='Tahoma' fill='%23000'>  "
         chrs.each_with_index do |c, i| 
  ...
  def svg_radar(window, total_chrs, total_otus)
    s = "data:image/svg+xml,
           ...
           <g transform='scale(.5)'>
             <rect fill='%23bbb' x='0' y='0' width='#{total_chrs}' height='#{total_otus}' />
