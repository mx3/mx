...
module App::DisplayHelper
  ...
  def t_cell_obj_actions(o) # return show/edit/destroy tables cells for object o
    ...
    r << content_tag(:td, link_to('Destroy', {:action => :destroy, :controller => klass, :id => o.id}, :method => "delete", :confirm => ([Ref, Otu].include?(o.class) ? "WARNING! You are about to delete EVERYTHING in this project that is directly tied to this #{o.class}.  Are you sure you want to do this?" : "Are you sure?")), :class => :list_action)
    r.html_safe
  end
